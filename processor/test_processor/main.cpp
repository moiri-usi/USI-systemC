...
int sc_main(int argc, char *argv[]) {
        ...
        Register_17bit reg17("reg17");
        Register_8bit reg8_1("reg8_1");
        Register_8bit reg8_2("reg8_2");
        Register_8bit reg8_3("reg8_3");
        Register_8bit reg8_4("reg8_4");
        Mux_4to1_8bit mux_4to1_8_1("mux_4to1_8_1");
        Mux_4to1_8bit mux_4to1_8_2("mux_4to1_8_2");
        Mux_2to1_8bit mux_2to1_8("mux_2to1_8");
        Decoder decoder("decoder");
        Controller controller("controller");
        Register_File regF("regF");
        Execution_Unit exe("exe");

        reg17.clk(clk);
        reg17.reset_n(mod_reset_n);
        reg17.in(mod_instruction);
        reg17.out(s_inst_r);
        reg8_1.clk(clk);
        reg8_1.reset_n(mod_reset_n);
        reg8_1.in(s_immediate);
        reg8_1.out(s_immediate_r);
        reg8_2.clk(clk);
        reg8_2.reset_n(mod_reset_n);
        reg8_2.in(s_op1_int);
        reg8_2.out(s_op1_r);
        reg8_3.clk(clk);
        reg8_3.reset_n(mod_reset_n);
        reg8_3.in(s_op);
        reg8_3.out(s_op_r);
        reg8_4.clk(clk);
        reg8_4.reset_n(mod_reset_n);
        reg8_4.in(s_op2);
        reg8_4.out(s_op2_r);
        ...
        controller.clk(clk);
        controller.reset_n(mod_reset_n);
        ...
        sc_trace(t_file, s_op, "s_op");
        sc_trace(t_file, s_op_r, "s_op_r");
        sc_trace(t_file, s_op1_r, "s_op1_r");
        sc_trace(t_file, s_op2_r, "s_op2_r");
        sc_trace(t_file, s_sel_op, "s_sel_op");
        sc_trace(t_file, s_immediate, "s_immediate");
        sc_trace(t_file, s_immediate_r, "s_immediate_r");
